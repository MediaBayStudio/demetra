<aside id="mobile-menu" class="menu bg-light-blue" style="display: none;">
  <div class="menu__cnt container lazy" data-src="#">
    <div class="menu__hdr">
      <a href="<?php echo $site_url ?>" class="menu__link">
        <img src="<?php echo $logo_url ?>" alt="логотип" class="hdr__logo">
      </a>
      <button type="button" class="menu__close">
        <svg width="21" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" class="menu__close-svg"><path stroke="#2b4758" d="M20.4455.353553L1.35359 19.4454M19.7384 19.4455L.646481.353591" class="menu__close-path"/></svg>
      </button>
    </div>

    <a href="tel:<?php echo $tel_dry; ?>" class="hdr__mob-tel"><?php echo $tel; ?></a>
