...
// const USER_SERV_DEST = 'test',
          SITE_NAME = 'demetratour',
          // PC_USERNAME = 'vadim';
          PC_USERNAME = 'Vadim';

const paths = {
  localServer: path.join(USER_SERV_DEST, SITE_NAME),
  theme: path.join(USER_SERV_DEST, SITE_NAME, 'wp-content', 'themes',  'demetra'),
  src: 'src',
...
const config = {
  ...
  wpAdmin: 'admin',
  siteTtitle: 'Demetra&nbsp;Tour',
  siteDescr: 'Атмосферные&nbsp;экскурсии&nbsp;по&nbsp;Санкт&#8209;Петербургу&nbsp;и&nbsp;не&nbsp;только!',
